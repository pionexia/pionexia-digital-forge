    ...
    <section id="contact" className="py-16 bg-gray-50 dark:bg-pionexia-dark-secondary">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 dark:text-white">Contactez-nous</h2>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-1 bg-white dark:bg-pionexia-dark-accent/80 p-6 rounded-lg shadow-md backdrop-blur-sm">
              <h3 className="text-xl font-semibold mb-4 dark:text-white">Informations de contact</h3>
              
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium mb-2 dark:text-gray-200">Adresse</h4>
                ...
                <div>
                  <h4 className="font-medium mb-2 dark:text-gray-200">Email</h4>
                  <a 
                ...
                <div>
                  <h4 className="font-medium mb-2 dark:text-gray-200">Horaires</h4>
              ...
              <div className="mt-8">
                <h4 className="font-medium mb-3 dark:text-gray-200">Suivez-nous</h4>
            ...
            <div className="md:col-span-2 bg-white dark:bg-pionexia-dark-accent/80 p-6 rounded-lg shadow-md backdrop-blur-sm">
              <h3 className="text-xl font-semibold mb-4 dark:text-white">Envoyez-nous un message</h3>
              <ContactForm />
            </div>
          </div>
        </div>
